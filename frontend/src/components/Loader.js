...
const Loader = () => {
  return (
    <button
      disabled
      type="button"
      className="py-2.5 px-5 mr-2 text-sm font-medium text-gray-100 bg-gray-800 rounded-lg border border-gray-700 flex items-center justify-center gap-2 cursor-not-allowed"
    >
      <svg
        aria-hidden="true"
        role="status"
